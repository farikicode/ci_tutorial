 ...
 */
class Apps{
    var $name="CI Tutorial - Web Application";
    var $title="CI Tutorial";
    var $logintitle="CI Tutorial Web App";
    var $logindesc="Please login access your application";
    var $logintag="CI Tutorial for Educational";
    var $release="Version 1.0.0";
    var $ver="Version 1.0.0";
    var $modname="";
    var $moddesc="";
    var $copyright = "pudyastoadi.my.id";
    var $dept = "ICT";
    var $statnav="active";
    var $companyname = "PAW!";
